...
- 🔭 Currently building a bilingual, mobile-first onboarding platform for a U.S. financial institution @ **GFT Technologies** (Bradesco US project)
- 🎓 Currently pursuing a postgraduate degree in **Artificial Intelligence and Data Science**
- 🤝 Ask me about React/Next.js architecture, micro-frontends, design systems, or AI-assisted engineering workflows
- 📫 Reach me on **[LinkedIn](https://www.linkedin.com/in/atirson-fabiano/)**
...
### 🤖 Also in the day-to-day toolbox
...
- **AI-first delivery** — adopted Claude & Gemini in daily engineering, cutting execution time by up to **91.7%** on smaller tasks and **66.7%** on larger ones @ GFT Technologies.
- **Cost & performance** — refactored Headless CMS integrations and caching, cutting service requests from **3.29M to 34K/month** @ GFT Technologies.
- **Quality culture** — raised automated test coverage from **17% to 90%+** on a Next.js application while eliminating SonarQube code smells.
- **0→1 ownership** — led front-end architecture for Vivo Fibra Lite from zero to production, reaching **1M+ visits/month** and **R$100K+** in monthly revenue @ Zup Innovation.
- **Scale** — grew Natura/Avon's Vitrine consultant platform to support **100K+ requests/minute** for **6M+ active consultants** @ CI&T.
- **Global reach** — localized an AB InBev e-commerce platform across the UK, Bolivia, Germany, Belgium and the Netherlands.
...
<a href="mailto:fabiano.oliveira2213@gmail.com" target="_blank">
